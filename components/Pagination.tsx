    ...
    <div className="flex items-center justify-center gap-4 mt-10">
      {currentPage > 1 ? (
        <Link 
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-[#0a0a0a] text-white/60 hover:text-white hover:border-cyan-400/50 transition-colors font-medium text-sm"
        >
